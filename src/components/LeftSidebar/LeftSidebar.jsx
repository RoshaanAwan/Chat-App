...
const LeftSidebar = () => {
    ...
    const { userData, chatData, chatUser, setChatUser, setMessagesId, chatVisible, setChatVisible } = useContext(AppContext);
    ...
    useEffect(() => {
        ...
        const updateChatUserData = async () => {
            if (chatUser) {
                const userRef = doc(db(db, 'users', chatUser.userData.id));
